...
However, a common feature in most scalings is that typical lengthscales are still some power-law of Rayleigh number $d/R \sim \mathrm{Ra}^{-\beta}$.
...
\section{Conclusion}
We have developed a framework for approximating the rates of true polar wander in terms of a small number of nondimensional numbers.
