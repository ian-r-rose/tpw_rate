...
($\phi=45^\circ, \theta\approx 55^\circ$), then it can be expressed in terms of
...
The second invariant of the moment of inertia deviator can be similarly useful as a scalar estimate of the ``rotational stress.''
...
Splitting the volume into $V_H$ and $\Delta V$ and substituting Equation~\eqref{eq:eos} into Equation~\eqref{eq:quasistatic_angular_momentum}, we find
\begin{equation}
\begin{aligned}
