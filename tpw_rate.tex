...
This equation may be identified with \eqref{eq:disequilibrium}, where disequilibrium in the rotational deformation (left side) is balanced by a the mismatch of the convective moment of intertia with the spin axis (right side).
...
Therefore we expect, to a good approximation, that we will be able to cut off the infinite sum in Equation \eqref{eq:T_series} at some maximum wavenumber, set by the smallest lengthscale $d$:
\begin{equation}
