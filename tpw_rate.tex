...
Furthermore, the quantity $(\lambda_i-\lambda_j)$ which appears in the denominator is precisely the same as the quantity which we estimated in the previous section to scale with $\sim \mathrm{Ra}^{-1}$.
...
This result is consistent with the result of \citet{richards1997explanation}.
