...
&+ \sin^2{\theta} \cos^2{\theta} \tan^2{\theta} \cos^2{\phi}\sin^2{\phi} \left( \lambda_2 - \lambda_1 \right)^2 \\
&=
\sin^2{\theta}\cos^2{\theta} \left[( \lambda_3 - \lambda_1)^2 \cos^2{\phi} + (\lambda_3 - \lambda_2)^2 \sin^2{\phi}
+ \tan^2{\theta} \cos^2{\phi}\sin^2{\phi} \left( \lambda_2 - \lambda_1 \right)^2 \right] \\
\end{aligned}
\end{equation}
...
\begin{aligned}
\frac{\dot{\mitbf{\omega}}^2}{A^2}  &= 
\frac{1}{4}\sin^2{2\theta} \left[( \lambda_3 - \lambda_1)^2 \cos^2{\phi} + (\lambda_3 - \lambda_2)^2 \sin^2{\phi}
+ \frac{1}{4}\tan^2{\theta} \sin^2{2\phi}\left( \lambda_2 - \lambda_1 \right)^2 \right] \\
\end{aligned}
\end{equation}
