...
\end{equation}
 ...
 where the parameters are defined in Table~\ref{parameters} and $\varepsilon({\bf v}) = 1/2 \; ( \partial v_i / \partial x_j + \partial v_j / \partial x_i )$ corresponds to the symmetrized velocity gradient.  In addition we use the simple equation of state
...
Dimensional analysis of this system (cf. \citet{barenblatt1996scaling}) requires six nondimensional numbers to characterize it.
...
Nondimensionalizing the integral for $E_ij$ we find
